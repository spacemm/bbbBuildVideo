...
/**
 * Created by space on 3/5/14.
 */
public class videoSlot {
    public static List<Map<String, List<Long>>> videoSlot(Map<String, Long> videoStart, Map<String, Long> videoStop, Long startTime, Long stopTime){
        ...
        while(videoStart.size()>0){
            ...
            sVideoStart= sortByValue.sortByValue(videoStart);
